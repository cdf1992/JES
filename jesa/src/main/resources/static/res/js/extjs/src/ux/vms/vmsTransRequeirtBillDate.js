								...
								items : [{					
									...
									items: [{
										...
										handler : function() {
											...
											exportExcelHF(column,"交易开票记录",'vmsTransactionInquireSelectBillDate.ajax?transId='+transId,fs,grid);
										}
									}]
										...
										items:[{
											...
											items : [/*{
 											    ...
 											    store: Ext.create('Ext.data.Store', {
 									                fields: ['key', 'value'],
 									                data: vmsCustomerFapiaoFlagList
 									            }),
 									            value:transFapiaoFlag,
 									            displayField : 'value',
 									            editable : false,  
												...
												name:'taxRate',
 											    ...
 											    id:'taxCnyBalance',
 											    name:'taxCnyBalance',
 											    value:transInfo[0].taxCnyBalance,
 									            fieldStyle:'border:none',
 											    labelAlign:'right',
 											},{
 												fieldLabel: '价税合计',
 												...
 												name:'dataStatus',
 											    displayField: 'text',    
 											    value:Ext.decode(result.VMS_TRANS_DATA_STATUS)[''+transInfo[0].datastatus+''].key,
 									            fieldStyle:'border:none',
 											    labelAlign:'right',
 											}
 											]
