...
import jes.sys.filter.XssAndSqlFilter;
...
import jes.boot.config.filter.PenetrationFilter;
import jes.boot.config.mybatis.MybatisPagingInterceptor;
...
public class GlobalConfig {
	...
	@Bean
	public FilterRegistrationBean<PenetrationFilter> penetrationFilterRegister() {
		FilterRegistrationBean<PenetrationFilter> register = new FilterRegistrationBean<PenetrationFilter>(new PenetrationFilter());
	...
	@Bean
	public FilterRegistrationBean<XssAndSqlFilter> xssAndSqlFilterRegister() {
		FilterRegistrationBean<XssAndSqlFilter> register = new FilterRegistrationBean<XssAndSqlFilter>(new XssAndSqlFilter());
		register.addUrlPatterns("*.do", "*.html", "*.ajax");
		return register;
	}
	...
	@Bean
	public MybatisPagingInterceptor mybatisPagingInterceptor() {
		MybatisPagingInterceptor mybatisPagingInterceptor = new MybatisPagingInterceptor();
		Properties properties = new Properties();
		mybatisPagingInterceptor.setProperties(properties);
		return mybatisPagingInterceptor;
	}
